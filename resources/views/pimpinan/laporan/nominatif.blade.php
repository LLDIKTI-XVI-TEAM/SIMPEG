<x-layouts.app title="Laporan Nominatif Pegawai">
    <div class="space-y-6">
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-ink">Laporan Nominatif Pegawai</h1>
        ...
        <div x-data="{ filterOpen: true }">
            <x-ui.card padding="none" class="overflow-hidden">
                <button type="button" @click="filterOpen = !filterOpen" :aria-expanded="filterOpen.toString()" aria-controls="nominatif-filter-panel"
                ...
                <div id="nominatif-filter-panel" x-show="filterOpen" x-collapse class="bg-soft/30">
                    <div class="p-6">
            ...
            <div class="flex flex-col items-start justify-between gap-4 border-t border-border bg-surface px-6 py-4 sm:flex-row sm:items-center">
                <div class="flex flex-wrap items-center gap-4 text-sm text-muted">
                    <div class="flex items-center gap-2">
                        ...
                        <label for="pimpinan-nominatif-per-page" class="sr-only">Jumlah baris per halaman</label>
                        <select id="pimpinan-nominatif-per-page" form="filter-form" name="per_page" onchange="this.form.submit()" class="appearance-none bg-none rounded-md border border-border bg-surface px-2.5 py-1 text-sm text-ink focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary font-sans cursor-pointer text-center">
