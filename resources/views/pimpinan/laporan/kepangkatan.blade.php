    ...
    <div class="space-y-6">
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex shrink-0 items-center gap-3">
                <x-ui.button type="submit" form="filter-form" variant="secondary" size="md" formaction="{{ route('laporan.kepangkatan.pdf') }}" formtarget="_blank">
                ...
                <x-ui.button type="submit" form="filter-form" variant="secondary" size="md" formaction="{{ route('laporan.kepangkatan.excel') }}" formtarget="_blank">
                    <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" /></svg>
                    Unduh Excel
                </x-ui.button>
            </div>
        ...
        <div x-data="{ filterOpen: true }">
            <x-ui.card padding="none" class="overflow-hidden">
                ...
                <div x-show="filterOpen" x-collapse class="bg-soft/30">
                    <div class="p-6">
            <form id="filter-form" action="{{ route('laporan.kepangkatan') }}" method="GET" class="space-y-4" aria-describedby="rank-report-help">
