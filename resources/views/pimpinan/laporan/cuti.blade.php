    ...
    <div class="space-y-6">
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex shrink-0 items-center gap-3">
                ...
                <x-ui.button type="submit" form="filter-form" variant="secondary" size="md" formaction="{{ route('pimpinan.laporan.cuti.excel') }}" formtarget="_blank">
            ...
            <x-ui.card padding="none" class="overflow-hidden">
                <button type="button" @click="filterOpen = !filterOpen"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-left">
                            <p class="text-sm font-semibold text-ink font-sans">Filter dan Export Laporan Cuti</p>
                            <p id="leave-report-help" class="text-xs text-muted font-sans mt-0.5">Preview dan Excel menggunakan data pengajuan cuti aktual dengan filter yang sama.</p>
                        </div>
                    </div>
                ...
                <div x-show="filterOpen" x-collapse class="bg-soft/30">
                    <div class="p-6">
                        <form id="filter-form" action="{{ route('pimpinan.laporan.cuti') }}" method="GET" class="space-y-4" aria-describedby="leave-report-help">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    <div>
                        <label for="tahun" class="mb-2 block text-sm font-semibold text-ink">Tahun</label>
                        <x-form.input onchange="this.form.submit()" id="tahun" name="tahun" :value="$filters['tahun'] ?? now()->year" type="number" min="2000" max="2100" size="md" aria-describedby="leave-report-help tahun-error" />
                        @error('tahun')
                    ...
                    <div>
                        ...
                        <x-form.select onchange="this.form.submit()" id="bulan" name="bulan" aria-describedby="leave-report-help" size="md">
                    ...
                    <div>
                        ...
                        <x-form.select onchange="this.form.submit()" id="employee_id" name="employee_id" aria-describedby="leave-report-help" size="md">
                    ...
                    <div>
                        ...
                        <x-form.select onchange="this.form.submit()" id="unit_kerja_id" name="unit_kerja_id" aria-describedby="leave-report-help" size="md">
                    ...
                    <div>
                        ...
                        <x-form.select onchange="this.form.submit()" id="jenis_cuti_id" name="jenis_cuti_id" aria-describedby="leave-report-help" size="md">
        ...
        <x-ui.card padding="none" class="overflow-hidden">
            <div class="px-6 py-4 border-b border-border bg-surface print:hidden">
                <h3 class="text-sm font-semibold text-ink font-sans">Preview Data Cuti</h3>
            </div>
            <div class="overflow-x-auto">
                <x-ui.table>
                    ...
                    <x-ui.table-body>
                        ...
                        @empty
                            <x-ui.table-row>
                                <x-ui.table-td colspan="5" align="center" class="px-4 py-8 text-muted">Tidak ada pengajuan cuti pada periode ini.</x-ui.table-td>
                            </x-ui.table-row>
                        @endforelse
                    </x-ui.table-body>
                </x-ui.table>
