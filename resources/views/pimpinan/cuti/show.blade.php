                        ...
                        <div>
                            ...
                            <dd>
                                @if ($attachmentAvailable)
                                    <a href="{{ route('pimpinan.cuti.attachment.download', $leave) }}" download class="inline-flex items-center gap-3 p-3 rounded-lg border border-border bg-soft cursor-pointer hover:bg-surface transition-colors w-max">
