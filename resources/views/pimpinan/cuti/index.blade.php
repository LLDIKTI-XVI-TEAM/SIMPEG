    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <x-ui.button href="{{ route('pimpinan.laporan.cuti') }}" variant="secondary" size="md">
                    <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            ...
                            <x-ui.table-row class="hover:bg-soft transition-colors border-b border-border/50 group" :interactive="true">
                                ...
                                <x-ui.table-td>
                                    <div class="flex items-center justify-end gap-1.5">
                                        <x-ui.button href="{{ route('pimpinan.cuti.show', $leave) }}" variant="secondary" size="icon" title="Detail" aria-label="Detail">
