        ...
        <form method="GET" action="#" class="flex flex-col gap-4 p-4">
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                <div class="flex items-center gap-2 rounded-lg border border-border bg-surface px-3 py-1.5">
                    ...
                    <input name="search" type="text" placeholder="Cari Pegawai..." class="flex-1 bg-transparent text-sm text-ink placeholder:text-muted focus:outline-none font-sans">
                </div>
                
                <div class="relative">
                    <select name="indikator" class="w-full appearance-none rounded-lg border border-border bg-surface pl-3 pr-10 py-1.5 text-sm text-ink focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 font-sans">
                        <option value="">Semua Indikator</option>
                        <option value="merah">Merah (H-30)</option>
                        <option value="kuning">Kuning (H-60)</option>
                        <option value="hijau">Hijau (H-90)</option>
                    </select>
                </div>
            </div>
        </form>
                        ...
                        <x-ui.table-row :interactive="true">
                            ...
                            <x-ui.table-td class="text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    <x-ui.button href="{{ route('pimpinan.pegawai.show', $ews['id']) }}" variant="secondary" size="sm" title="Detail Pegawai">
                                        Detail
                                    </x-ui.button>
                                </div>
                            </x-ui.table-td>
