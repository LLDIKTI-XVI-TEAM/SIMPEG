<x-layouts.app title="Dashboard" subtitle="Ringkasan operasional kepegawaian dan pemantauan tindak lanjut.">
    ...
    <div class="relative mb-6 flex min-h-[140px] w-full flex-col overflow-hidden rounded-xl bg-gradient-to-r from-[#173292] to-[#2143c2] px-5 py-4 shadow-md lg:flex-row lg:items-center">
        <div class="pointer-events-none absolute inset-0 overflow-hidden rounded-xl" aria-hidden="true">
            <div class="absolute right-4 top-2 opacity-20">
                <svg width="40" height="30" fill="currentColor" class="text-white">
                    <pattern id="dashboard-dots" x="0" y="0" width="8" height="8" patternUnits="userSpaceOnUse">
                        <circle cx="1.5" cy="1.5" r="1.5"></circle>
                    </pattern>
                    <rect width="40" height="30" fill="url(#dashboard-dots)"></rect>
                </svg>
            </div>
            <svg class="absolute right-[20%] top-0 h-full text-white/5" viewBox="0 0 200 400" preserveAspectRatio="none">
                <path d="M 200 -50 Q 50 200 200 450" fill="none" stroke="currentColor" stroke-width="40"></path>
                <path d="M 280 -50 Q 130 200 280 450" fill="none" stroke="currentColor" stroke-width="20"></path>
            </svg>
        </div>

        <div class="relative z-10 flex w-full flex-col justify-center lg:w-[70%]">
            <p class="mb-0.5 text-[10px] font-bold uppercase tracking-widest text-white/70">Selamat datang kembali</p>
            <h2 class="text-xl font-extrabold leading-tight text-white sm:text-2xl">{{ auth()->user()->name }}</h2>
            <p class="mt-1 max-w-lg text-[12px] text-white/80">
                Semangat menjalankan tugas hari ini. Tetap produktif dan berikan pelayanan terbaik.
            </p>

            <div class="mt-3 flex flex-wrap items-center gap-2.5">
                <div class="flex cursor-default items-center gap-3 rounded-lg border border-white/10 bg-white/10 px-3 py-2 backdrop-blur-md transition-colors hover:bg-white/15">
                    <div class="shrink-0 text-white/90">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V7.5M3 10.5h18" />
                        </svg>
                    </div>
                    <div class="h-6 w-px bg-white/20"></div>
                    <div class="mt-0.5 flex flex-col">
                        <span class="text-[12px] font-medium leading-none text-white/90">{{ now()->translatedFormat('l, d F Y') }}</span>
                        <span class="mt-0.5 text-[10px] text-white/70">Hari ini</span>
                    </div>
                </div>
                ...
                <div class="flex cursor-default items-center gap-3 rounded-lg border border-white/10 bg-white/10 px-3 py-2 backdrop-blur-md transition-colors hover:bg-white/15">
                    <div class="shrink-0 text-white/90">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18" />
                        </svg>
                    </div>
                    <div class="h-6 w-px bg-white/20"></div>
                    <div class="mt-0.5 flex flex-col">
                        <span class="text-[12px] font-medium leading-none text-white/90">Sistem Informasi Kepegawaian</span>
                        <span class="mt-0.5 text-[10px] text-white/70">LLDIKTI Wilayah XVI</span>
                    </div>
                </div>
            </div>
        </div>

        <div class="pointer-events-none absolute bottom-0 right-6 z-10 hidden w-[175px] lg:block" aria-hidden="true">
            <svg class="h-auto w-full drop-shadow-xl" viewBox="0 0 415 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M 150 260 L 250 260 Q 260 260 255 250 L 235 200 L 165 200 L 145 250 Q 140 260 150 260 Z" fill="#142C80"></path>
                <rect x="185" y="200" width="30" height="20" fill="#142C80"></rect>
                <rect x="30" y="40" width="340" height="180" rx="14" fill="#E2E8F0" stroke="#FFFFFF" stroke-width="6"></rect>
                <rect x="40" y="50" width="320" height="160" rx="8" fill="#FFFFFF"></rect>
                <circle cx="80" cy="90" r="22" fill="#E2E8F0"></circle>
                <circle cx="80" cy="85" r="9" fill="#94A3B8"></circle>
                <path d="M 62 107 Q 80 85 98 107 Z" fill="#94A3B8"></path>
                <rect x="135" y="145" width="18" height="45" rx="4" fill="#3B82F6"></rect>
                <rect x="165" y="120" width="18" height="70" rx="4" fill="#60A5FA"></rect>
                <rect x="195" y="85" width="18" height="105" rx="4" fill="#2563EB"></rect>
                <circle cx="300" cy="115" r="40" fill="#E2E8F0"></circle>
                <path d="M 300 115 L 300 75 A 40 40 0 0 1 340 115 Z" fill="#2563EB"></path>
                <circle cx="300" cy="115" r="16" fill="#FFFFFF"></circle>
                <rect x="100" y="180" width="100" height="90" rx="10" fill="#F8FAFC" stroke="#FFFFFF" stroke-width="4"></rect>
                <rect x="100" y="180" width="100" height="28" rx="8" fill="#3B82F6"></rect>
                <rect x="100" y="198" width="100" height="10" fill="#3B82F6"></rect>
                <rect x="115" y="168" width="8" height="24" rx="4" fill="#1E40AF"></rect>
                <rect x="177" y="168" width="8" height="24" rx="4" fill="#1E40AF"></rect>
                <circle cx="118" cy="225" r="4" fill="#CBD5E1"></circle>
                <circle cx="134" cy="225" r="4" fill="#CBD5E1"></circle>
                <circle cx="150" cy="225" r="4" fill="#CBD5E1"></circle>
                <circle cx="166" cy="225" r="4" fill="#CBD5E1"></circle>
                <circle cx="182" cy="225" r="4" fill="#CBD5E1"></circle>
                <circle cx="118" cy="242" r="4" fill="#CBD5E1"></circle>
                <circle cx="134" cy="242" r="4" fill="#CBD5E1"></circle>
                <circle cx="150" cy="242" r="4" fill="#CBD5E1"></circle>
                <circle cx="166" cy="242" r="4" fill="#CBD5E1"></circle>
                <circle cx="182" cy="242" r="4" fill="#CBD5E1"></circle>
                <circle cx="118" cy="259" r="4" fill="#CBD5E1"></circle>
                <circle cx="134" cy="259" r="4" fill="#3B82F6"></circle>
                <path d="M 335 260 L 385 260 L 375 215 L 345 215 Z" fill="#F8FAFC" stroke="#E2E8F0" stroke-width="2"></path>
                <path d="M 360 215 Q 330 180 345 135 Q 370 170 360 215" fill="#64748B" opacity="0.3"></path>
                <path d="M 360 215 Q 380 175 395 155 Q 405 195 360 215" fill="#64748B" opacity="0.4"></path>
            </svg>
        </div>
    </div>
