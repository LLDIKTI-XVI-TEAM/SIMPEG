    ...
    <div class="space-y-6">
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('dokumen') }}" class="inline-flex items-center justify-center rounded-lg border border-primary/15 bg-surface px-4 py-2 text-sm font-semibold text-primary transition-colors hover:bg-soft focus:outline-none">
