                    ...
                    <x-ui.table-row>
                        ...
                        <x-ui.table-td padding="sm" class="whitespace-nowrap">
                            <div class="flex items-center justify-start gap-1.5">
                                ...
                                <form method="POST" action="{{ route('data-master.golongan.toggle', $item) }}" class="inline">
                                    @csrf
                                    <input type="hidden" name="tab" value="golongan">
                                    <x-ui.button
                                        type="submit"
                                ...
                                @if ($dipakai === 0)
                                    <form method="POST" action="{{ route('data-master.golongan.destroy', $item) }}" class="inline"
