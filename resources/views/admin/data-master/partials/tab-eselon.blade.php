...
<div x-show="activeTab === 'eselon'"
    ...
    <div class="pb-4 flex items-center justify-between">
        <div>
            ...
            <p class="text-[11px] text-muted mt-0.5 font-sans leading-normal">Data referensi kode eselon struktural.
                    ...
                    <x-ui.table-row>
                        ...
                        <x-ui.table-td align="right" padding="sm">
                            <div class="flex items-center justify-end gap-1.5">
                                ...
                                <form method="POST" action="{{ route('data-master.eselon.toggle', $item) }}">
                                    @csrf
                                    <input type="hidden" name="tab" value="eselon">
                                    <button type="submit"
                                ...
                                @if ($dipakai === 0)
                                    <form method="POST" action="{{ route('data-master.eselon.destroy', $item) }}"
