<x-layouts.app title="Data Master">
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-ink font-sans">Data Master / Reference Tables</h1>
    ...
    <div x-data="{ 
        ...
        <aside class="w-full lg:w-64 shrink-0 lg:sticky lg:top-6 lg:self-start">
            <div class="rounded-lg bg-surface p-4 shadow-sm space-y-1">
                <p
                    class="text-xs font-bold text-muted uppercase tracking-wide px-3 pb-2 mb-2 font-sans">
        ...
        <main class="flex-1 min-w-0 space-y-4">
            ...
            <x-ui.alert variant="info" size="sm">
                <p class="font-bold">Informasi Integritas Data Master & Audit Log:</p>
                <ul class="mt-1 list-disc space-y-1 pl-4 font-sans">
            ...
            <div x-show="activeTab === 'jenis_cuti'"
                ...
                <div class="border-b border-border pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h2 class="text-xl font-semibold text-ink font-sans leading-tight">Jenis Cuti</h2>
                        <p class="mt-0.5 max-w-2xl text-xs text-muted font-sans leading-normal">Data referensi jenis-jenis
                                ...
                                <x-ui.table-row :interactive="true">
                                    ...
                                    <x-ui.table-td align="center" padding="sm">
                                        @if($item['khusus_pns'] === 'Ya')
                                            <x-ui.badge variant="primary" size="sm">Ya</x-ui.badge>
                                        @else
                                            <x-ui.badge variant="muted" size="sm">Tidak</x-ui.badge>
                                        @endif
                                    </x-ui.table-td>
                                    <x-ui.table-td padding="sm">
                                        <div class="flex items-center justify-start gap-1.5">
                                            <x-ui.button type="button" @click="openModal('edit')" variant="secondary" size="compact-icon" title="Edit" aria-label="Edit jenis cuti">
                                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                                                </svg>
                                            </x-ui.button>
                                            <x-ui.button type="button" @click="openDeleteConfirm({ name: '{{ $item['nama'] }}' })" variant="danger" size="compact-icon" title="Hapus" aria-label="Hapus jenis cuti {{ $item['nama'] }}">
                                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
            ...
            <div x-show="activeTab === 'agama'"
                ...
                <div class="border-b border-border pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h2 class="text-xl font-semibold text-ink font-sans leading-tight">Agama</h2>
                        <p class="mt-0.5 max-w-2xl text-xs text-muted font-sans leading-normal">Data referensi agama resmi.
                        </p>
                    </div>
                    <x-ui.button @click="openModal('tambah')" variant="secondary" class="shrink-0">
                        Tambah
                        ...
                        <x-ui.table-body>
                            @foreach($dataAgama as $item)
                                <x-ui.table-row :interactive="true">
                                    ...
                                    <x-ui.table-td padding="sm">
                                        <div class="flex items-center justify-start gap-1.5">
                                            <x-ui.button type="button" @click="openModal('edit')" variant="secondary" size="compact-icon" title="Edit" aria-label="Edit agama">
                                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                                                </svg>
                                            </x-ui.button>
                                            <x-ui.button type="button" @click="openDeleteConfirm({ name: '{{ $item['nama'] }}' })" variant="danger" size="compact-icon" title="Hapus" aria-label="Hapus agama {{ $item['nama'] }}">
                                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                                </svg>
                                            </x-ui.button>
            ...
            <div x-show="activeTab === 'jenis_kelamin'"
                ...
                <div class="border-b border-border pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h2 class="text-xl font-semibold text-ink font-sans leading-tight">Jenis Kelamin</h2>
                        <p class="mt-0.5 max-w-2xl text-xs text-muted font-sans leading-normal">Data referensi jenis kelamin.
                        </p>
                    </div>
                    <x-ui.button @click="openModal('tambah')" variant="secondary" class="shrink-0">
                        Tambah
                        ...
                        <x-ui.table-body>
                            @foreach($dataJenisKelamin as $item)
                                <x-ui.table-row :interactive="true">
                                    ...
                                    <x-ui.table-td padding="sm">
                                        <div class="flex items-center justify-start gap-1.5">
                                            <x-ui.button type="button" @click="openModal('edit')" variant="secondary" size="compact-icon" title="Edit" aria-label="Edit jenis kelamin">
                                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                                                </svg>
                                            </x-ui.button>
                                            <x-ui.button type="button" @click="openDeleteConfirm({ name: '{{ $item['nama'] }}' })" variant="danger" size="compact-icon" title="Hapus" aria-label="Hapus jenis kelamin {{ $item['nama'] }}">
                                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                                </svg>
                                            </x-ui.button>
            ...
            <div x-show="activeTab === 'status_perkawinan'"
                ...
                <div class="border-b border-border pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h2 class="text-xl font-semibold text-ink font-sans leading-tight">Status Perkawinan</h2>
                        <p class="mt-0.5 max-w-2xl text-xs text-muted font-sans leading-normal">Data referensi status
                            perkawinan.</p>
                    </div>
                    <x-ui.button @click="openModal('tambah')" variant="secondary" class="shrink-0">
                        Tambah
                        ...
                        <x-ui.table-body>
                            @foreach($dataStatusPerkawinan as $item)
                                <x-ui.table-row :interactive="true">
                                    ...
                                    <x-ui.table-td padding="sm">
                                        <div class="flex items-center justify-start gap-1.5">
                                            <x-ui.button type="button" @click="openModal('edit')" variant="secondary" size="compact-icon" title="Edit" aria-label="Edit status perkawinan">
                                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                                                </svg>
                                            </x-ui.button>
                                            <x-ui.button type="button" @click="openDeleteConfirm({ name: '{{ $item['nama'] }}' })" variant="danger" size="compact-icon" title="Hapus" aria-label="Hapus status perkawinan {{ $item['nama'] }}">
                                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                                </svg>
                                            </x-ui.button>
