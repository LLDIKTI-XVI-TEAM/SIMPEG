    ...
    <div class="space-y-4">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex shrink-0 flex-wrap items-center gap-2">
                <button type="button" @click="openSkFileModal('sk_pangkat')"
                    class="inline-flex items-center gap-1.5 rounded-lg border border-primary/20 bg-primary/5 px-3 py-2 text-xs font-semibold text-primary transition hover:bg-primary/10 font-sans">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    </svg>
                    Unggah / Perbaiki Berkas SK
                </button>
    ...
    >
        <div class="space-y-3">
            <p class="text-xs text-muted font-sans">
                Sistem otomatis memperbaiki riwayat SK yang berstatus <em>perlu perbaikan</em> (berkas belum diunggah atau file hilang);
                jika tidak ada yang perlu diperbaiki, berkas disimpan sebagai arsip dokumen.
            </p>
