            ...
            <div class="rounded-lg border border-border bg-surface p-6 shadow-sm space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3">
                    <button type="button" @click="activeTemplate = 'utama'; downloadTemplate('utama')" :disabled="downloadingType !== ''"
                        :class="(activeTemplate === 'utama' ? 'border-primary/20 bg-primary/5 text-primary' : 'border-border bg-surface text-ink hover:bg-soft') + (downloadingType && downloadingType !== 'utama' ? ' opacity-40' : '') + (downloadingType ? ' cursor-not-allowed' : '')"
                        ...
                        <span class="text-xs font-sans font-normal flex items-center gap-1" :class="activeTemplate === 'utama' ? 'text-primary' : 'text-ink'"><svg x-show="downloadingType === 'utama'" x-cloak class="w-3 h-3 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"></path></svg><span x-text="downloadingType === 'utama' ? 'Menyiapkan...' : 'Template Utama'"></span></span>
                        <span class="text-[9px] text-muted font-sans mt-0.5">(NIP, NIK, No KK, dll.)</span>
                    </button>
                    <button type="button" @click="activeTemplate = 'pelengkap'; downloadTemplate('pelengkap')" :disabled="downloadingType !== ''"
                        :class="(activeTemplate === 'pelengkap' ? 'border-primary/20 bg-primary/5 text-primary' : 'border-border bg-surface text-ink hover:bg-soft') + (downloadingType && downloadingType !== 'pelengkap' ? ' opacity-40' : '') + (downloadingType ? ' cursor-not-allowed' : '')"
                        class="flex flex-col items-center justify-center p-3 rounded-lg text-center transition group cursor-pointer border">
                        ...
                        <span class="text-xs font-sans font-normal flex items-center gap-1" :class="activeTemplate === 'pelengkap' ? 'text-primary' : 'text-ink'"><svg x-show="downloadingType === 'pelengkap'" x-cloak class="w-3 h-3 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"></path></svg><span x-text="downloadingType === 'pelengkap' ? 'Menyiapkan...' : 'Data Pelengkap'"></span></span>
                        <span class="text-[9px] text-muted font-sans mt-0.5">(NIK, KK, TTL, dll.)</span>
                    </button>
                    <button type="button" @click="activeTemplate = 'kepangkatan'; downloadTemplate('kepangkatan')" :disabled="downloadingType !== ''"
                        :class="(activeTemplate === 'kepangkatan' ? 'border-primary/20 bg-primary/5 text-primary' : 'border-border bg-surface text-ink hover:bg-soft') + (downloadingType && downloadingType !== 'kepangkatan' ? ' opacity-40' : '') + (downloadingType ? ' cursor-not-allowed' : '')"
                        class="flex flex-col items-center justify-center p-3 rounded-lg text-center transition group cursor-pointer border">
                        ...
                        <span class="text-xs font-sans font-normal flex items-center gap-1" :class="activeTemplate === 'kepangkatan' ? 'text-primary' : 'text-ink'"><svg x-show="downloadingType === 'kepangkatan'" x-cloak class="w-3 h-3 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"></path></svg><span x-text="downloadingType === 'kepangkatan' ? 'Menyiapkan...' : 'Riwayat Pangkat'"></span></span>
                        <span class="text-[9px] text-muted font-sans mt-0.5">(Append-only)</span>
                    </button>
                    <button type="button" @click="activeTemplate = 'jabatan'; downloadTemplate('jabatan')" :disabled="downloadingType !== ''"
                        :class="(activeTemplate === 'jabatan' ? 'border-primary/20 bg-primary/5 text-primary' : 'border-border bg-surface text-ink hover:bg-soft') + (downloadingType && downloadingType !== 'jabatan' ? ' opacity-40' : '') + (downloadingType ? ' cursor-not-allowed' : '')"
                        class="flex flex-col items-center justify-center p-3 rounded-lg text-center transition group cursor-pointer border">
                        ...
                        <span class="text-xs font-sans font-normal flex items-center gap-1" :class="activeTemplate === 'jabatan' ? 'text-primary' : 'text-ink'"><svg x-show="downloadingType === 'jabatan'" x-cloak class="w-3 h-3 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"></path></svg><span x-text="downloadingType === 'jabatan' ? 'Menyiapkan...' : 'Riwayat Jabatan'"></span></span>
                        <span class="text-[9px] text-muted font-sans mt-0.5">(Append-only)</span>
                    </button>
                    <button type="button" @click="activeTemplate = 'kgb'; downloadTemplate('kgb')" :disabled="downloadingType !== ''"
                        :class="(activeTemplate === 'kgb' ? 'border-primary/20 bg-primary/5 text-primary' : 'border-border bg-surface text-ink hover:bg-soft') + (downloadingType && downloadingType !== 'kgb' ? ' opacity-40' : '') + (downloadingType ? ' cursor-not-allowed' : '')"
                        class="flex flex-col items-center justify-center p-3 rounded-lg text-center transition group cursor-pointer border">
                        ...
                        <span class="text-xs font-sans font-normal flex items-center gap-1" :class="activeTemplate === 'kgb' ? 'text-primary' : 'text-ink'"><svg x-show="downloadingType === 'kgb'" x-cloak class="w-3 h-3 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"></path></svg><span x-text="downloadingType === 'kgb' ? 'Menyiapkan...' : 'Riwayat KGB'"></span></span>
                        <span class="text-[9px] text-muted font-sans mt-0.5">(Append-only)</span>
                    </button>
                </div>
            </div>
