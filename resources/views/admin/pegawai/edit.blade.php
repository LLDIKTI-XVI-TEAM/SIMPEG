            ...
            <form action="{{ route('pegawai.update', $p->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div x-show="activeTab === 'utama'" class="space-y-6" x-transition>
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        {{-- Nama dengan Gelar --}}
                        <div class="space-y-1">
                            <label for="nama_dengan_gelar"
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Nama dengan
                                Gelar</label>
                            <input id="nama_dengan_gelar" name="nama_dengan_gelar" type="text"
                                placeholder="Grantly Sorongan, S.Kom."
                                ...
                                value="{{ old('nama_dengan_gelar', $p->nama_dengan_gelar) }}">
                            <p class="text-xs text-muted">Nama yang ditampilkan pada kartu &amp; header. Boleh kosong
                                jika sama dengan nama lengkap.</p>
                        </div>

                        {{-- Nama Lengkap (tanpa gelar) --}}
                        <div class="space-y-1">
                            <label for="nama_lengkap"
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Nama Lengkap
                                (tanpa gelar)</label>
                            <input id="nama_lengkap" name="nama_lengkap" type="text"
                                placeholder="Grantly Antonio Edward Sorongan"
                                class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                value="{{ old('nama_lengkap', $p->nama_lengkap) }}">
                            <p class="text-xs text-muted">Nama lengkap resmi sesuai KTP atau SK, tanpa gelar akademik.
                                Data ini penting untuk dilengkapi.</p>
                        </div>
                            ...
                            <div class="relative w-full">
                                ...
                                <div class="absolute inset-y-0 right-0 flex items-center pr-2">
                                    <button type="button" @click="checkIdentity('nip')"
                                        ...
                                        :disabled="isCheckingNip || nip.length < 10">
                        ...
                        <div class="space-y-1">
                            <label class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Jenis
                                Pegawai</label>
                            <div
                                class="flex items-center gap-2 w-full rounded-lg border border-border bg-soft px-4 py-2 text-sm text-ink shadow-sm font-sans cursor-not-allowed">
                                ...
                                @if($currentJenisPegawai)
                                    <x-ui.badge variant="primary" size="md"
                                        class="!font-bold">{{ $currentJenisPegawai->nama }}</x-ui.badge>
                                @else
                        ...
                        <div class="space-y-1">
                            <label for="tanggal_lahir"
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Tanggal
                                Lahir</label>
                            <input id="tanggal_lahir" name="tanggal_lahir" type="date" max="{{ date('Y-m-d') }}"
                                ...
                                value="{{ $p->tanggal_lahir ? \Carbon\Carbon::parse($p->tanggal_lahir)->format('Y-m-d') : '' }}">
                            <p class="text-xs text-muted">Data ini penting untuk dilengkapi.</p>
                        </div>

                        {{-- Tanggal Pensiun --}}
                        <div class="space-y-1">
                            <label for="tanggal_pensiun"
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Tanggal Pensiun</label>
                            <input id="tanggal_pensiun" name="tanggal_pensiun" type="date"
                                class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans cursor-pointer"
                                value="{{ $p->tanggal_pensiun ? \Carbon\Carbon::parse($p->tanggal_pensiun)->format('Y-m-d') : '' }}">
                            <p class="text-xs text-muted">Opsional - Kosongkan untuk kalkulasi otomatis dari BUP</p>
                        </div>
                        ...
                        <div class="space-y-1 rounded-lg border border-border bg-soft/40 p-4 sm:col-span-2">
                            ...
                            <label for="is_kepala_lembaga"
                                class="flex items-start gap-3 text-sm font-semibold text-ink font-sans">
                                <input id="is_kepala_lembaga" name="is_kepala_lembaga" type="checkbox" value="1"
                                    @checked(old('is_kepala_lembaga', $p->is_kepala_lembaga))
                        ...
                        <div class="space-y-1">
                            <label
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Golongan</label>
                        ...
                        <div class="space-y-1">
                            <label class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Jabatan
                                Terakhir</label>
                        ...
                        <div class="space-y-1">
                            <label class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Unit
                                Kerja</label>
                            <div
                                class="flex items-center gap-2 w-full rounded-lg border border-border bg-soft px-4 py-2 text-sm text-ink shadow-sm font-sans cursor-not-allowed">
                                <svg class="w-4 h-4 text-muted shrink-0" fill="none" stroke="currentColor"
                        ...
                        <div class="space-y-1">
                            <label class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Kelas
                                Jabatan</label>
                ...
                <div x-show="activeTab === 'pelengkap'" class="space-y-6" style="display: none;" x-transition>
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="space-y-1">
                            <label for="no_kk"
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Nomor Kartu
                                Keluarga (KK)</label>
                        ...
                        <div class="space-y-1">
                            <label for="tempat_lahir"
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Tempat
                                Lahir</label>
                            <input id="tempat_lahir" name="tempat_lahir" type="text" placeholder="Bandung"
                                class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                        ...
                        <div class="space-y-2 sm:col-span-2 border-t border-border pt-4">
                            <label class="text-xs font-bold text-ink uppercase tracking-wider font-sans block">Foto
                                Profil Pegawai</label>
                            <div class="flex items-center gap-4">
                                <div
                                    class="h-16 w-16 rounded-full border border-border bg-soft flex items-center justify-center overflow-hidden shrink-0">
                                    <img x-show="fotoPreview" :src="fotoPreview" src="{{ $fotoUrl ?? '' }}"
                                        alt="Foto {{ $p->nama_lengkap }}"
                                        class="h-full w-full object-cover object-[center_25%]" @if(!$fotoUrl)
                                        style="display: none;" @endif>
                                    <div x-show="!fotoPreview" @if($fotoUrl) style="display: none;" @endif>
                                        <svg class="h-8 w-8 text-muted" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24" stroke-width="1.5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div x-show="activeTab === 'kontak'" class="space-y-6" style="display: none;" x-transition>
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="space-y-1">
                            <label for="no_hp"
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Nomor HP</label>
                            <input id="no_hp" name="no_hp" type="tel" placeholder="081234567890"
                                class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                value="{{ $p->no_hp }}">
                            <p class="text-xs text-muted">Data ini penting untuk dilengkapi.</p>
                        </div>
                        ...
                        {{-- Telepon Rumah --}}
                        <div class="space-y-1">
                            <label for="no_telepon_rumah"
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Telepon
                                Rumah</label>
                            <input id="no_telepon_rumah" name="no_telepon_rumah" type="tel" placeholder="0227301234"
                                class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                value="{{ $p->no_telepon_rumah }}">
                        </div>

                        {{-- Email Pribadi --}}
                        <div class="space-y-1 sm:col-span-2">
                            <label for="email_pribadi"
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Email
                                Pribadi</label>
                            <input id="email_pribadi" name="email_pribadi" type="email" placeholder="pegawai@domain.com"
                                class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                value="{{ $p->email_pribadi }}">
                        </div>

                        {{-- Alamat Lengkap --}}
                        <div class="space-y-1 sm:col-span-2">
                            <label for="alamat"
                                class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Alamat Tempat
                                Tinggal</label>
                            <textarea id="alamat" name="alamat" rows="3"
                                placeholder="Jl. Buah Batu No. 120, Lengkong, Bandung"
                                class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans resize-none">{{ $p->alamat }}</textarea>
                            <p class="text-xs text-muted">Data ini penting untuk dilengkapi.</p>
                        </div>
                    </div>
                </div>
                ...
                <div x-show="activeTab === 'pengangkatan'" class="space-y-6" style="display: none;" x-transition>
                    ...
                    <div x-show="subTab === 'pangkat'" class="space-y-6" x-transition>
                        ...
                        <div class="mb-4 border-b border-border pb-4">
                            <div class="rounded-lg border border-primary/30 bg-primary/5 px-4 py-3 font-sans">
                                <p class="text-xs font-bold text-primary uppercase tracking-wider">Tambah Riwayat
                                    Kepangkatan Baru</p>
                                <p class="mt-1 text-xs text-muted">Riwayat kepangkatan bersifat append-only — riwayat
                                    yang sudah tersimpan tidak dapat diubah dari form ini.</p>
                                @if($latestRank)
                                    <p class="mt-1 text-xs text-muted">Riwayat terbaru: <span
                                            class="font-semibold text-ink">{{ $latestRank->golongan?->nama ?? '-' }}</span>
                                        (TMT:
                                        {{ $latestRank->tmt_pangkat ? $latestRank->tmt_pangkat->format('d-m-Y') : '-' }})
                                    </p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            {{-- Nomor SK Pangkat --}}
                            <div class="space-y-1">
                                <label for="pangkat_no_sk"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Nomor SK
                                    Pangkat <span class="text-danger">*</span></label>
                                <input id="pangkat_no_sk" name="pangkat_no_sk" type="text"
                                    placeholder="SK-PANGKAT-321-KP-2026"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                    x-model="pangkatForm.no_sk">
                            </div>

                            {{-- Tanggal SK Pangkat --}}
                            <div class="space-y-1">
                                <label for="pangkat_tanggal_sk"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Tanggal SK
                                    <span class="text-danger">*</span></label>
                                <input id="pangkat_tanggal_sk" name="pangkat_tanggal_sk" type="date"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans cursor-pointer"
                                    x-model="pangkatForm.tanggal_sk">
                            </div>

                            {{-- TMT Pangkat --}}
                            <div class="space-y-1">
                                <label for="pangkat_tmt_pangkat"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">TMT Pangkat
                                    <span class="text-danger">*</span></label>
                                <input id="pangkat_tmt_pangkat" name="pangkat_tmt_pangkat" type="date"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans cursor-pointer"
                                    x-model="pangkatForm.tmt_pangkat">
                            </div>
                            ...
                            <div class="space-y-2 sm:col-span-2 border-t border-border pt-4">
                                ...
                                <div x-show="skPangkatMode === 'upload'" class="mt-1">
                                    <div
                                        ...
                                        <p class="text-xs text-ink font-semibold mt-2 font-sans">Klik atau Seret berkas
                                            SK Pangkat (PDF/JPG/PNG, maks 10MB)</p>
                                        <template x-if="skPangkatName && skPangkatMode === 'upload'">
                                            <div
                                                class="mt-3 inline-flex items-center gap-2 rounded bg-surface border border-border px-3 py-1.5 text-xs text-ink shadow-sm">
                                                ...
                                                <span class="text-muted" x-show="skPangkatSize"
                                        ...
                                        @endif
                                        <p x-show="skPangkatError"
                                            class="text-xs text-danger font-semibold mt-2 font-sans"
                                            x-text="skPangkatError"></p>
                                    </div>
                                </div>
                    ...
                    <div x-show="subTab === 'jabatan'" class="space-y-6" x-transition>
                        ...
                        <div class="mb-4 border-b border-border pb-4">
                            <div class="rounded-lg border border-primary/30 bg-primary/5 px-4 py-3 font-sans">
                                <p class="text-xs font-bold text-primary uppercase tracking-wider">Tambah Riwayat
                                    Jabatan Baru</p>
                                <p class="mt-1 text-xs text-muted">Riwayat jabatan bersifat append-only — riwayat yang
                                    sudah tersimpan tidak dapat diubah dari form ini.</p>
                                @if($latestPosition)
                                    <p class="mt-1 text-xs text-muted">Riwayat terbaru: <span
                                            class="font-semibold text-ink">{{ $latestPosition->nama_jabatan ?? '-' }}</span>
                                        (TMT:
                                        {{ $latestPosition->tmt_jabatan ? $latestPosition->tmt_jabatan->format('d-m-Y') : '-' }})
                                    </p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            {{-- Kelas Jabatan --}}
                            <div class="space-y-1">
                                <label for="jabatan_kelas_jabatan"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Kelas
                                    Jabatan</label>
                                <input id="jabatan_kelas_jabatan" name="jabatan_kelas_jabatan" type="text"
                                    placeholder="8"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                    x-model="jabatanForm.kelas_jabatan">
                            </div>
                            ...
                            {{-- Nomor SK Jabatan --}}
                            <div class="space-y-1">
                                <label for="jabatan_no_sk"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Nomor SK
                                    Jabatan <span class="text-danger">*</span></label>
                                <input id="jabatan_no_sk" name="jabatan_no_sk" type="text"
                                    placeholder="SK-JABATAN-910-JAB-2026"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                    x-model="jabatanForm.no_sk">
                            </div>

                            {{-- Tanggal SK Jabatan --}}
                            <div class="space-y-1">
                                <label for="jabatan_tanggal_sk"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Tanggal SK
                                    <span class="text-danger">*</span></label>
                                <input id="jabatan_tanggal_sk" name="jabatan_tanggal_sk" type="date"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans cursor-pointer"
                                    x-model="jabatanForm.tanggal_sk">
                            </div>
                            ...
                            <div class="space-y-1 sm:col-span-2">
                                <label for="jabatan_tmt_jabatan"
                                    ...
                                    <span class="text-danger">*</span></label>
                                <input id="jabatan_tmt_jabatan" name="jabatan_tmt_jabatan" type="date"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans cursor-pointer"
                                    x-model="jabatanForm.tmt_jabatan">
                            </div>
                            ...
                            <div class="space-y-2 sm:col-span-2 border-t border-border pt-4">
                                ...
                                <div x-show="skJabatanMode === 'upload'" class="mt-1">
                                    <div
                                        ...
                                        <p class="text-xs text-ink font-semibold mt-2 font-sans">Klik atau Seret berkas
                                            SK Jabatan (PDF/JPG/PNG, maks 10MB)</p>
                                        <template x-if="skJabatanName && skJabatanMode === 'upload'">
                                            <div
                                                ...
                                                <span class="text-muted" x-show="skJabatanSize"
                    ...
                    <div x-show="subTab === 'kgb'" class="space-y-6" x-transition>
                        ...
                        <div class="mb-4 border-b border-border pb-4">
                            <div class="rounded-lg border border-primary/30 bg-primary/5 px-4 py-3 font-sans">
                                <p class="text-xs font-bold text-primary uppercase tracking-wider">Tambah Riwayat KGB
                                    Baru</p>
                                <p class="mt-1 text-xs text-muted">Riwayat KGB bersifat append-only — riwayat yang sudah
                                    tersimpan tidak dapat diubah dari form ini.</p>
                                @if($latestSalary)
                                    <p class="mt-1 text-xs text-muted">Riwayat terbaru: <span
                                            class="font-semibold text-ink">Rp
                                            {{ number_format($latestSalary->gaji_pokok, 0, ',', '.') }}</span> (TMT:
                                        {{ $latestSalary->tmt_kgb ? $latestSalary->tmt_kgb->format('d-m-Y') : '-' }})</p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            {{-- Gaji Pokok --}}
                            <div class="space-y-1">
                                <label for="kgb_gaji_pokok"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Gaji Pokok
                                    Terakhir <span class="text-danger">*</span></label>
                                <div class="relative">
                                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
                                        <span class="text-muted text-sm font-semibold">Rp</span>
                                    </div>
                                    <input id="kgb_gaji_pokok" name="kgb_gaji_pokok" type="number" placeholder="5000000"
                                        class="w-full rounded-lg border border-border bg-surface pl-12 pr-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                        x-model="kgbForm.gaji_pokok">
                                </div>
                            </div>
                            ...
                            <div class="space-y-1">
                                <label for="kgb_no_sk"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Nomor SK KGB
                                    <span class="text-danger">*</span></label>
                                <input id="kgb_no_sk" name="kgb_no_sk" type="text" placeholder="SK-KGB-543-2026"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                    x-model="kgbForm.no_sk">
                            </div>

                            {{-- Tanggal SK KGB --}}
                            <div class="space-y-1">
                                <label for="kgb_tanggal_sk"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Tanggal SK
                                    <span class="text-danger">*</span></label>
                                <input id="kgb_tanggal_sk" name="kgb_tanggal_sk" type="date"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans cursor-pointer"
                                    x-model="kgbForm.tanggal_sk">
                            </div>

                            {{-- TMT KGB --}}
                            <div class="space-y-1">
                                <label for="kgb_tmt_kgb"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">TMT KGB <span
                                        class="text-danger">*</span></label>
                                <input id="kgb_tmt_kgb" name="kgb_tmt_kgb" type="date"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans cursor-pointer"
                                    x-model="kgbForm.tmt_kgb">
                            </div>
                            ...
                            <div class="space-y-2 sm:col-span-2 border-t border-border pt-4">
                                ...
                                <div x-show="skKgbMode === 'upload'" class="mt-1">
                                    <div
                                        ...
                                        <p class="text-xs text-ink font-semibold mt-2 font-sans">Klik atau Seret berkas
                                            SK KGB (PDF/JPG/PNG, maks 10MB)</p>
                                        <template x-if="skKgbName && skKgbMode === 'upload'">
                                            <div
                                                ...
                                                <span class="text-muted" x-show="skKgbSize"
                                        ...
                                        @endif
                                        <p x-show="skKgbError" class="text-xs text-danger font-semibold mt-2 font-sans"
                                            x-text="skKgbError"></p>
                                    </div>
                                </div>
                    ...
                    <div x-show="subTab === 'pengangkatan'" class="space-y-6" x-transition>
                        @if ($isPppkEmployee)
                            <div class="space-y-4 rounded-lg border border-primary/20 bg-primary/5 p-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-muted">Tanggal akhir kontrak diprioritaskan EWS. Jika
                                        kosong, EWS memakai TMT PPPK ditambah masa kontrak global.</p>
                                </div>
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div class="space-y-1">
                                        <label for="pppk_tmt_pengangkatan"
                                            class="text-xs font-bold text-ink uppercase tracking-wider font-sans">TMT
                                            Pengangkatan PPPK</label>
                                        <input id="pppk_tmt_pengangkatan" name="pppk_tmt_pengangkatan" type="date"
                                            value="{{ old('pppk_tmt_pengangkatan', $pppkAppointment?->tmt_pengangkatan?->format('Y-m-d')) }}"
                                        ...
                                        <p class="text-xs text-muted">Mengubah TMT pada riwayat SK Pengangkatan PPPK
                                            terbaru.</p>
                                        @error('pppk_tmt_pengangkatan')
                                        <p class="text-xs text-danger">{{ $message }}</p>@enderror
                                    </div>
                                    <div class="space-y-1">
                                        <label for="tanggal_akhir_kontrak"
                                            class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Tanggal
                                            Akhir Kontrak</label>
                                        <input id="tanggal_akhir_kontrak" name="tanggal_akhir_kontrak" type="date"
                                            value="{{ old('tanggal_akhir_kontrak', $p->tanggal_akhir_kontrak?->format('Y-m-d')) }}"
                                            class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 font-sans cursor-pointer">
                                        <p class="text-xs text-muted">Kosongkan untuk memakai TMT PPPK + masa kontrak
                                            global.</p>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            {{-- TMT Pengangkatan --}}
                            <div class="space-y-1">
                                <label for="pengangkatan_tmt_pengangkatan"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">TMT
                                    Pengangkatan <span class="text-danger">*</span></label>
                            ...
                            {{-- Tanggal SK --}}
                            <div class="space-y-1">
                                <label for="pengangkatan_tanggal_sk"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Tanggal SK
                            ...
                            <div class="space-y-2 sm:col-span-2 border-t border-border pt-4">
                                ...
                                <div x-show="skPengangkatanMode === 'upload'" class="mt-1">
                                    <div
                                        ...
                                        <p class="text-xs text-ink font-semibold mt-2 font-sans">Klik atau Seret berkas
                                            SK Pengangkatan (PDF/JPG/PNG, maks 10MB)</p>
                                        <template x-if="skPengangkatanName && skPengangkatanMode === 'upload'">
                                            <div
                                                ...
                                                <span class="text-muted" x-show="skPengangkatanSize"
                    ...
                    <div x-show="subTab === 'lainnya'" class="space-y-6" x-transition style="display: none;">
                        <div class="rounded-lg bg-soft/40 border border-border px-4 py-3">
                            <p class="text-[11px] text-muted font-sans">Berkas ini akan tersimpan ke arsip dokumen
                                pegawai saat Anda menekan tombol "Simpan Pegawai". Kosongkan bila tidak ingin menambah
                                berkas.</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            {{-- Jenis Berkas --}}
                            <div class="space-y-1">
                                <label for="berkas_lainnya_jenis"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Jenis Berkas
                                    <span class="text-danger">*</span></label>
                                <div class="relative">
                                    <select id="berkas_lainnya_jenis" name="berkas_lainnya_jenis"
                                        x-model="berkasLainnyaForm.jenis" @change="generateNomorDokumen()"
                                        class="w-full appearance-none rounded-lg border border-border bg-surface px-4 py-2 pr-10 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans cursor-pointer">
                            ...
                            <div class="space-y-1" x-show="berkasLainnyaForm.jenis === 'Lainnya'" x-transition>
                                <label for="berkas_lainnya_jenis_manual"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Sebutkan Jenis
                                    Berkas <span class="text-danger">*</span></label>
                                <input id="berkas_lainnya_jenis_manual" name="berkas_lainnya_jenis_manual" type="text"
                                    @input="generateNomorDokumen()" placeholder="Misal: Sertifikat Pelatihan"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                    x-model="berkasLainnyaForm.jenis_manual">
                            </div>

                            {{-- Nomor Dokumen --}}
                            <div class="space-y-1"
                                :class="berkasLainnyaForm.jenis !== 'Lainnya' ? 'sm:col-span-2' : ''">
                                <label for="berkas_lainnya_nomor"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Nomor
                                    Dokumen</label>
                                <input id="berkas_lainnya_nomor" name="berkas_lainnya_nomor" type="text"
                                    placeholder="KTP-1234-07-2026"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans"
                                    x-model="berkasLainnyaForm.nomor_dokumen">
                            </div>

                            {{-- Deskripsi Berkas --}}
                            <div class="space-y-1 sm:col-span-2">
                                <label for="berkas_lainnya_deskripsi"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Deskripsi</label>
                                <textarea id="berkas_lainnya_deskripsi" name="berkas_lainnya_deskripsi"
                                    style="min-height: 50px; height: 50px;"
                                    placeholder="Keterangan opsional terkait berkas"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans resize-none"
                                    x-model="berkasLainnyaForm.deskripsi"></textarea>
                            </div>

                            {{-- Tanggal Berkas --}}
                            <div class="space-y-1">
                                <label for="berkas_lainnya_tanggal"
                                    class="text-xs font-bold text-ink uppercase tracking-wider font-sans">Tanggal
                                    Berkas</label>
                                <input id="berkas_lainnya_tanggal" name="berkas_lainnya_tanggal" type="date"
                                    class="w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm text-ink shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-sans cursor-pointer"
                                    x-model="berkasLainnyaForm.tanggal">
                                <p class="text-xs text-muted">Boleh dikosongkan jika tidak relevan.</p>
                            </div>

                            {{-- Upload Berkas Lainnya --}}
                            <div class="space-y-2 sm:col-span-2 border-t border-border pt-4">
                                <label class="text-xs font-bold text-ink uppercase tracking-wider font-sans block">File
                                    Berkas Lainnya <span class="text-danger">*</span></label>
                                <div class="mt-1">
                                    <div
                                        class="border-2 border-dashed border-border rounded-lg p-6 bg-soft/50 text-center relative hover:border-primary transition">
                                        <input type="file" id="file_berkas_lainnya" name="file_berkas_lainnya"
                                            accept=".pdf,image/*" @change="handleBerkasLainnyaChange"
                                            class="absolute inset-0 opacity-0 cursor-pointer w-full h-full">
                                        <svg class="mx-auto h-10 w-10 text-muted" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24" stroke-width="1">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <template x-if="berkasLainnyaName">
                                            <div
                                                ...
                                                <span class="text-muted" x-show="berkasLainnyaSize"
                                                    x-text="'(' + berkasLainnyaSize + ')'"></span>
                                            </div>
                                        </template>
                                        <p x-show="berkasLainnyaError"
                                            class="text-xs text-danger font-semibold mt-2 font-sans"
                                            x-text="berkasLainnyaError"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
