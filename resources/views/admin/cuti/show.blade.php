        ...
        <div class="rounded-lg border border-border bg-surface p-6 shadow-sm space-y-6">
            ...
            <div class="border-t border-border pt-6 space-y-4" x-data="{ showTunda: false }">
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('cuti') }}" class="inline-flex items-center justify-center rounded-lg border border-primary/15 bg-surface px-4 py-2 text-sm font-semibold text-primary transition-colors hover:bg-soft">
