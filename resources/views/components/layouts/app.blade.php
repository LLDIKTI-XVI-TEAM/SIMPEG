    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
            ...
            $menus = [
                ...
                ['label' => 'Import Data Pegawai',                 'route' => 'pegawai.import',        'icon' => 'arrow-up-tray'],
                ['label' => 'Cuti',                                'route' => 'cuti',                  'icon' => 'calendar'],
                ['label' => 'EWS',                                 'route' => 'ews',                   'icon' => 'exclamation-triangle'],
                ['label' => 'Notifikasi',                          'route' => 'notifications.index',   'icon' => 'bell'],
                ['label' => 'Dokumen & SK',                        'route' => 'dokumen',               'icon' => 'folder-open'],
                ['label' => 'Laporan / Export',                    'route' => 'laporan',               'icon' => 'document-chart-bar'],
                ...
                ['label' => 'Reference Tables',                    'route' => 'data-master',           'icon' => 'table-cells'],
                ['label' => 'Konfigurasi Approval Cuti',           'route' => 'cuti.config',           'icon' => 'adjustments-horizontal'],
