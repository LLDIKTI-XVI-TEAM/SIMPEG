    ...
    <div {{ $attributes->merge(['class' => 'grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4']) }}>
        @if($searchModel || $searchId)
            ...
            <div class="{{ $searchCols }} space-y-1.5 flex flex-col justify-end">
                ...
                @endif
                <div class="flex items-center gap-2 rounded-lg border border-border bg-surface px-3 py-1.5 focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary w-full">
