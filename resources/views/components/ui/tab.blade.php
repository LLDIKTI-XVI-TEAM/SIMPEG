...
@php
    $styles = [
        'underline' => [
            'base' => 'shrink-0 pb-2 text-xs md:text-sm transition-colors cursor-pointer focus:outline-none font-sans',
            'active' => 'border-b-2 border-primary text-primary font-bold',
            'inactive' => 'text-muted hover:text-ink font-semibold',
        ],
        'sidebar' => [
            'base' => 'w-full rounded-lg px-4 py-3 text-left text-sm transition-colors cursor-pointer focus:outline-none font-sans flex items-center justify-between gap-3',
            'active' => 'bg-primary text-white font-semibold',
            'inactive' => 'text-muted hover:bg-soft hover:text-ink font-medium',
        ],
        'sidebar-soft' => [
            'base' => 'w-full py-2.5 text-left text-sm transition-all cursor-pointer focus:outline-none font-sans flex items-center justify-between gap-3',
        ...
        'pills' => [
            'base' => 'rounded-lg border px-3.5 py-2 text-sm transition-colors cursor-pointer focus:outline-none font-sans',
