    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <x-ui.stat-card label="Jatah Tahunan ({{ date('Y') }})" value="{{ $saldoCuti['jatah_dasar'] ?? 0 }}" variant="primary" size="md" accent>
                    <x-slot:icon>
                ...
                <x-ui.stat-card label="Hak Efektif Tahun Ini" value="{{ $saldoCuti['saldo_dapat_diajukan'] ?? 0 }}" unit="Hari" variant="success" size="md" accent role="group" aria-label="{{ $saldoCuti['saldo_dapat_diajukan'] ?? 0 }} Hari">
                    <x-slot:icon>
