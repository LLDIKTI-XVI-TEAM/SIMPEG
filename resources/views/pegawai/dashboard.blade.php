                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-2 sm:gap-3 text-[11px] sm:text-xs text-white/90 font-sans">
                        ...
                        <div class="flex items-center gap-1.5 bg-white/10 px-3 py-1.5 rounded-full backdrop-blur-md border border-white/20 shadow-sm hover:bg-white/20 transition-colors">
                            ...
                            <span class="line-clamp-1 max-w-[150px] sm:max-w-[200px] font-medium tracking-wide">{{ $employee?->latestPosition()?->unitKerja?->nama ?? '-' }}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <x-ui.stat-card label="Jatah Tahunan ({{ date('Y') }})" value="{{ $saldoCuti?->jatah_awal ?? 12 }}" variant="primary" size="md" accent>
                    <x-slot:icon>
                ...
                <x-ui.stat-card label="Carry Over (N-1)" value="{{ $saldoCuti?->carry_over ?? 0 }}" variant="info" size="md" accent>
                    <x-slot:icon>
                ...
                <x-ui.stat-card label="Sisa Saldo Cuti" value="{{ $saldoCuti?->sisa ?? ($saldoCuti?->jatah_awal ?? 12) }}" variant="success" size="md" accent>
                    <x-slot:icon>
