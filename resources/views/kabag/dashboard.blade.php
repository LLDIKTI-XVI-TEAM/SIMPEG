<x-layouts.app title="Dashboard" subtitle="Ringkasan eksekutif dan pemantauan aktivitas bawahan hari ini.">
    ...
    <div class="mb-6 grid grid-cols-1 gap-6 sm:grid-cols-3">
        ...
        <x-ui.stat-card href="{{ route('kepala-bagian.bawahan.index') }}" label="Total Bawahan Aktif" value="{{ $totalBawahan }}" variant="primary" size="lg" accent>
            <x-slot:icon>
        ...
        <x-ui.stat-card href="{{ route('kepala-bagian.bawahan.index') }}" label="Bawahan Sedang Cuti" value="{{ $sedangCuti }}" variant="info" size="lg" accent>
            <x-slot:icon>
                                ...
                                <x-ui.table-td class="px-6 py-3.5">
                                    <div class="flex items-center gap-3">
                                        <x-ui.tooltip text="Buka detail {{ $ews['nama'] }}" position="right">
                                            <a href="{{ route('kepala-bagian.bawahan.show', ['id' => $ews['id']]) }}" class="relative flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full border border-border bg-primary/10 text-xs font-bold text-primary transition hover:border-primary hover:ring-2 hover:ring-primary/20 focus:outline-none focus:ring-2 focus:ring-primary/30" aria-label="Buka detail profil {{ $ews['nama'] }}">
                                                <span>{{ substr($ews['nama'], 0, 1) }}</span>
                                            </a>
                                        </x-ui.tooltip>
                                        <div class="min-w-0">
                                            <x-ui.tooltip text="Buka detail {{ $ews['nama'] }}" position="right">
                                                <a href="{{ route('kepala-bagian.bawahan.show', ['id' => $ews['id']]) }}" class="block truncate text-xs font-semibold text-ink transition hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/20 rounded leading-tight">{{ $ews['nama'] }}</a>
                                            </x-ui.tooltip>
                                        </div>
                                    </div>
                                </x-ui.table-td>
                        ...
                        <x-ui.table-row class="hover:bg-soft transition-colors border-b border-border/50 group">
                            <x-ui.table-td class="px-6 py-3.5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="min-w-0">
                                        <x-ui.tooltip text="Buka detail {{ $bawahan['nama'] }}" position="right">
                                            <a href="{{ route('kepala-bagian.bawahan.show', ['id' => $bawahan['id']]) }}" class="block truncate text-xs font-semibold text-ink transition hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/20 rounded leading-tight">{{ $bawahan['nama'] }}</a>
                                        </x-ui.tooltip>
                            ...
                            <x-ui.table-td align="right" class="px-6 py-3.5">
                                <x-ui.button as="a" href="{{ route('kepala-bagian.bawahan.show', ['id' => $bawahan['id']]) }}" variant="secondary" size="icon" title="Lihat Detail" tooltip-position="top-end">
