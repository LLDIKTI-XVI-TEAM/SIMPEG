...
class ExportPegawaiPdfAction
{
     ...
     * menghabiskan memori server. PII (email, no_hp) tidak dicantumkan di PDF.
     *
     * @param  array<string, mixed>  $filters
     */
    public function execute(array $filters): StreamedResponse|RedirectResponse
    {
    ...
    private function pageStream(Collection $rows, int $page, int $totalPages): string
    {
        ...
        $stream = [
            ...
            '30 552 782 20 re f',
            '1 1 1 rg',
            $this->text(42, 559, 13, 'LAPORAN DAFTAR PEGAWAI'),
            '0 0 0 rg',
