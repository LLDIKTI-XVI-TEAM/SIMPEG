...
class ReferenceTableIsActiveMigrationTest extends TestCase
{
    ...
    private const TABLES_WITH_IS_ACTIVE = [
        ...
        // Model RefBup sudah deprecated dan tidak dipakai perhitungan BUP, tetapi tabelnya
        // dipertahankan pada Fase 1 dan tetap disentuh migrasi sehingga kontraknya ikut dijaga.
        // Tabel ini bukan bagian kebijakan hapus hybrid (absen dari ReferenceTableCatalog).
        'ref_bup',
        // Dua tabel berikut mendapat is_active dari migrasi sebelumnya; ikut
        // dikunci di sini agar cakupan kolom migrasi tetap lengkap.
        'ref_jabatan',
        'ref_unit_kerja',
    ];

    /**
     * Mengunci daftar tabel yang disentuh migrasi is_active, bukan daftar tabel kebijakan hybrid.
     */
    public function test_seluruh_tabel_yang_disentuh_migrasi_memiliki_kolom_is_active(): void
    {
